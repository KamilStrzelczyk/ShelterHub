...
/** Central class for managing application dimensions, spacing, and sizing. */
public class Dimensions {
  ...
  public static final int BORDER_RADIUS_XLARGE = 25;
  ...
  public static final int INPUT_FIELD_PADDING = 10;
}
